...
export const getProcessDetails = createAction(
  "[PROCESS], getting process details"
);
export const setProcessDetails = createAction(
  "[PROCESS], setting process details",
  props<{ process: ProcessMetadata }>()
);
